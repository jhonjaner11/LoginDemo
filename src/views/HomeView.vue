<template>
  ...
  <v-row >
    <v-card  color="green-lighten-3"  class="mx-auto">
      <ChartFewDetail />
    </v-card>
  </v-row>
  ...
  <v-row  class="mx-auto" align-content="center" align="center" justify="center">
    <v-col cols="11" >
        ...
        <v-btn stacked append-icon="mdi-package-variant-plus"> Agregar <br> Producto
        </v-btn>



      <v-btn stacked append-icon="mdi-account-tie" color="success">
        Agregar<br>  Provedor

      </v-btn>
      <v-btn color="grey" stacked append-icon="mdi-robot-confused" >
